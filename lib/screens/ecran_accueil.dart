            ...
            children: [
              ListTile(
                ...
                onTap: () async {
                  ...
                  if (image != null) context.read<VilleViewModel>().mettreAJourPhoto(image.path);
                },
              ),
              ListTile(
                ...
                onTap: () async {
                  ...
                  final image = await ImagePicker().pickImage(source: ImageSource.camera); // ⚠️ vérifie bien "camera" ici, pas "gallery"
                  if (image != null) context.read<VilleViewModel>().mettreAJourPhoto(image.path);
                },
              ),
            ],
          ...
          ElevatedButton.icon(
            ...
            onPressed: () async {
              ...
              if(position != null) {
                ...
                final villeProche = service.trouverVilleProche(position, vm.villes, MeteoService.coordss);
                if(villeProche != null) {
                          ...
                          return Column(children: [
                            AnimatedSwitcher(
                              ...
                              child: Text(
                                ...
                                key: ValueKey('${vm.villeSelectionnee?.nom}-${meteo.temperature}'),
